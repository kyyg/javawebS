...
<div class="container">
  ...
  <form method="post">
    ...
    <table class="table table-bordered">
      ...
      <tr>
        <th>이메일</th>
        <td><input type="text" name="email" id="email" value="aaa1234@naver.com" class="form-control" /></td>
      </tr>
      <tr>
        <td colspan="2" class="text-center">
          <input type="button" value="QR코드 생성" onclick="qrCheck()" class="btn btn-success mr-3">
          <input type="button" value="다시입력" onclick="location.reload()" class="btn btn-success">
        </td>
      </tr>
    </table>
  </form>
