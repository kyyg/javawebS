  ...
  <jsp:include page="/WEB-INF/views/include/bs4.jsp" />
    ...
    function qrCheck() {
    	...
    	if(movieName.trim() == "" || movieDate.trim() == "" || movieTime.trim() == "") {
			...
			// QR코드 내역 : 영화제목_상영날짜_상영시간_성인티켓수_아동티켓수_아이디    	
    	movieTemp = movieName + "_";
    	movieTemp += movieDate + "_";
    	movieTemp += movieTime + "_";
    	movieTemp += movieAdult + "A_";
    	movieTemp += movieChild + "C";
  ...
  <form method="post">
  	티켓 예매하기 :  
		<table class="table table-bordered">
			...
			<tr>
				<td colspan="2">
					<input type="button" value="티켓예매하기" onclick="qrCheck()" class="btn btn-info mr-2" />
					<input type="reset" value="다시예매하기" class="btn btn-info mr-2" />
